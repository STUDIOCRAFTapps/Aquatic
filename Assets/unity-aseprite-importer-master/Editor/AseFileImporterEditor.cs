...
namespace AsepriteImporter
{
    ...
    public class AseFileImporterEditor : ScriptedImporterEditor
    {
        ...
        private void DrawAnimationSetting(SerializedProperty animationSettings)
        {
            ...
            {
                EditorGUILayout.PropertyField(animationSettings.FindPropertyRelative("animationType"));
                EditorGUILayout.PropertyField(animationSettings.FindPropertyRelative("returnToOnEnd"));
                EditorGUILayout.PropertyField(animationSettings.FindPropertyRelative("callbacks"));
